...
export const DELIVERY_STATUSES = ["PENDING_RETAIL", "CONFIRMED", "CONFIRMED_WITH_IMEIS"] as const;
...
export const ORDER_STATUSES = ["OPEN", "OWNER_ACCEPTED", "OWNER_PREPARED", "ASSIGNED", "COMPLETED", "CANCELLED"] as const;
